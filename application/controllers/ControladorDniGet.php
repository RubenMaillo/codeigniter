...
class ControladorDniGet extends CI_Controller{
...
function recibirDatos(){
  ...
  $datos['dni1']= $this->input->get('dni');
  $datos['letra1']= $this->input->get('letra');
  $datos['nombre1']= $this->input->get('nombre');
  $datos['sueldo1']= $this->input->get('sueldo');
